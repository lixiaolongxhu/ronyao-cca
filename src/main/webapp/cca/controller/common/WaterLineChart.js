//水位线图controller
Ext.define('RYIVS.controller.common.WaterLineChart', {
	extend : 'Ext.app.Controller',
	models : ['common.TempWin'],
	stores : ['common.TempWin'],
	views : ['common.WaterLineChart'],

	init : function() {
		this.control({
			//日期选择
			'waterLineChart datefield' : {
				change : this.onDateChange
			},
			'waterLineChart' : {
				onShow : this.onShow
			},
			'waterLineChart button[fun=1]' : {
				click : this.onLastDay
			},
			'waterLineChart button[fun=2]' : {
				click : this.nextDay
			}
		});
	...
	onLastDay : function() {
		var datefield = Ext.ComponentQuery.query('waterLineChart datefield')[0];
	...
	onDateChange : function() {
		var pa = Ext.ComponentQuery.query('waterLineChart')[0];
