/**
 * controller : SF6历史数据曲线
 * author : tqd
 * date : 2013-4-11
 */
Ext.define('RYIVS.controller.common.SF6Chart', {
	extend : 'Ext.app.Controller',
	models : ['common.TempWin'],
	stores : ['common.TempWin'],
	views : ['common.SF6Chart'],
	...
	init : function() {
		this.control({
			...
			'SF6Chart button[fun=1]' : {
				click : this.onLastDay
			},
			'SF6Chart button[fun=2]' : {
				click : this.nextDay
			}
		});
	...
	onLastDay : function() {
		var datefield = Ext.ComponentQuery.query('SF6Chart datefield')[0];
	...
	onDateChange : function() {
		var pa = Ext.ComponentQuery.query('SF6Chart')[0];
