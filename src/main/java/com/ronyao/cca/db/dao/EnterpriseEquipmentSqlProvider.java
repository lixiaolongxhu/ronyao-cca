...
public class EnterpriseEquipmentSqlProvider {
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        EnterpriseEquipment record = (EnterpriseEquipment) parameter.get("record");
        EnterpriseEquipmentExample example = (EnterpriseEquipmentExample) parameter.get("example");
     ...
     * @mbggenerated Tue Dec 29 14:59:40 CST 2015
     */
    protected void applyWhere(EnterpriseEquipmentExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
