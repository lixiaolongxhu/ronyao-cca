...
public interface EnterprisePerFileMapper {
     ...
     */
    @Delete({
        "delete from enterprise_per_file",
    ...
    List<EnterprisePerFile> selectByExampleWithRowbounds(EnterprisePerFileExample example, RowBounds rowBounds);
    ...
    int updateByExampleSelective(@Param("record") EnterprisePerFile record, @Param("example") EnterprisePerFileExample example);
    ...
    int updateByExample(@Param("record") EnterprisePerFile record, @Param("example") EnterprisePerFileExample example);
