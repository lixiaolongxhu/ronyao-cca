...
public class AnnualOutputSqlProvider {
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        AnnualOutputExample example = (AnnualOutputExample) parameter.get("example");
     ...
     * @mbggenerated Tue Dec 29 14:59:40 CST 2015
     */
    protected void applyWhere(AnnualOutputExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
