...
public interface EnterprisePersonMapper {
    ...
    @Insert({
        ...
        "values (#{enterpriseid,jdbcType=INTEGER}, #{constructorone,jdbcType=INTEGER}, ",
        "#{constructortwo,jdbcType=INTEGER}, #{constructortotal,jdbcType=INTEGER}, ",
        "#{staffmiddle,jdbcType=INTEGER}, #{staffhigh,jdbcType=INTEGER}, ",
        "#{stafftotal,jdbcType=INTEGER}, #{skillmiddle,jdbcType=INTEGER}, ",
        "#{skillhigh,jdbcType=INTEGER}, #{skilltech,jdbcType=INTEGER}, ",
        "#{skilltechhigh,jdbcType=INTEGER}, #{skilltotal,jdbcType=INTEGER}, ",
    ...
    List<EnterprisePerson> selectByExampleWithRowbounds(EnterprisePersonExample example, RowBounds rowBounds);
    ...
    int updateByExampleSelective(@Param("record") EnterprisePerson record, @Param("example") EnterprisePersonExample example);
    ...
    int updateByExample(@Param("record") EnterprisePerson record, @Param("example") EnterprisePersonExample example);
    ...
    @Update({
        ...
        "set enterpriseId = #{enterpriseid,jdbcType=INTEGER},",
          "constructorOne = #{constructorone,jdbcType=INTEGER},",
          "constructorTwo = #{constructortwo,jdbcType=INTEGER},",
          "constructorTotal = #{constructortotal,jdbcType=INTEGER},",
          "staffMiddle = #{staffmiddle,jdbcType=INTEGER},",
          "staffHigh = #{staffhigh,jdbcType=INTEGER},",
          "staffTotal = #{stafftotal,jdbcType=INTEGER},",
          "skillMiddle = #{skillmiddle,jdbcType=INTEGER},",
          "skillHigh = #{skillhigh,jdbcType=INTEGER},",
          "skillTech = #{skilltech,jdbcType=INTEGER},",
          "skillTechHigh = #{skilltechhigh,jdbcType=INTEGER},",
          "skillTotal = #{skilltotal,jdbcType=INTEGER},",
