...
public interface BehaviorStandardMapper {
    ...
    List<BehaviorStandardWithBLOBs> selectByExampleWithBLOBsWithRowbounds(BehaviorStandardExample example, RowBounds rowBounds);
    ...
    List<BehaviorStandardWithBLOBs> selectByExampleWithBLOBs(BehaviorStandardExample example);
    ...
    List<BehaviorStandard> selectByExampleWithRowbounds(BehaviorStandardExample example, RowBounds rowBounds);
    ...
    int updateByExampleSelective(@Param("record") BehaviorStandardWithBLOBs record, @Param("example") BehaviorStandardExample example);
    ...
    int updateByExampleWithBLOBs(@Param("record") BehaviorStandardWithBLOBs record, @Param("example") BehaviorStandardExample example);
    ...
    int updateByExample(@Param("record") BehaviorStandard record, @Param("example") BehaviorStandardExample example);
