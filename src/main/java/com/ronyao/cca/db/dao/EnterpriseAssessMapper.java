...
public interface EnterpriseAssessMapper {
    ...
    List<EnterpriseAssess> selectByExampleWithBLOBsWithRowbounds(EnterpriseAssessExample example, RowBounds rowBounds);
    ...
    List<EnterpriseAssess> selectByExampleWithBLOBs(EnterpriseAssessExample example);
    ...
    List<EnterpriseAssess> selectByExampleWithRowbounds(EnterpriseAssessExample example, RowBounds rowBounds);
    ...
    @Select({
        ...
        "createTime, updateTime, enterprise",
    ...
    int updateByExampleSelective(@Param("record") EnterpriseAssess record, @Param("example") EnterpriseAssessExample example);
    ...
    int updateByExampleWithBLOBs(@Param("record") EnterpriseAssess record, @Param("example") EnterpriseAssessExample example);
    ...
    int updateByExample(@Param("record") EnterpriseAssess record, @Param("example") EnterpriseAssessExample example);
