...
public class BehaviorStandardSqlProvider {
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        BehaviorStandardWithBLOBs record = (BehaviorStandardWithBLOBs) parameter.get("record");
        BehaviorStandardExample example = (BehaviorStandardExample) parameter.get("example");
     ...
     * @mbggenerated Tue Dec 29 14:59:40 CST 2015
     */
    protected void applyWhere(BehaviorStandardExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
