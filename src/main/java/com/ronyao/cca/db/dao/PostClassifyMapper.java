...
public interface PostClassifyMapper {
     ...
     */
    @Insert({
        "insert into post_classify (id, name)",
    ...
    List<PostClassify> selectByExampleWithRowbounds(PostClassifyExample example, RowBounds rowBounds);
    ...
    int updateByExampleSelective(@Param("record") PostClassify record, @Param("example") PostClassifyExample example);
    ...
    int updateByExample(@Param("record") PostClassify record, @Param("example") PostClassifyExample example);
