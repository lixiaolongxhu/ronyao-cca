...
public class EnterpriseSqlProvider {
    ...
    public String insertSelective(Enterprise record) {
        ...
        if (record.getProject() != null) {
            VALUES("project", "#{project,jdbcType=TINYINT}");
        }
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        EnterpriseExample example = (EnterpriseExample) parameter.get("example");
        ...
        if (record.getProject() != null) {
            SET("project = #{record.project,jdbcType=TINYINT}");
        }
    ...
    public String updateByPrimaryKeySelective(Enterprise record) {
        ...
        if (record.getProject() != null) {
            SET("project = #{project,jdbcType=TINYINT}");
        }
     ...
     * @mbggenerated Wed Dec 09 15:42:41 CST 2015
     */
    protected void applyWhere(EnterpriseExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
