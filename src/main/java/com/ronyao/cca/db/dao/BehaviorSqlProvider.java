...
public class BehaviorSqlProvider {
	...
	public String insertSelective(Behavior record) {
		...
		if (record.getCorrection() != null) {
			VALUES("correction", "#{correction,jdbcType=DECIMAL}");
		}
	...
	public String updateByExampleSelective(Map<String, Object> parameter) {
		...
		if (record.getCorrection() != null) {
			SET("correction = #{record.correction,jdbcType=DECIMAL}");
		}
		if (record.getCreatetime() != null) {
	...
	public String updateByPrimaryKeySelective(Behavior record) {
		...
		if (record.getCorrection() != null) {
			SET("correction = #{correction,jdbcType=DECIMAL}");
		}
		if (record.getCreatetime() != null) {
	 ...
	 * @mbggenerated  Fri Dec 18 15:29:24 CST 2015
	 */
	protected void applyWhere(BehaviorExample example,
