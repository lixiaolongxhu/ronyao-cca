...
public interface EnterprisePerManageMapper {
     ...
     */
    @Delete({
        "delete from enterprise_per_manage",
    ...
    List<EnterprisePerManage> selectByExampleWithRowbounds(EnterprisePerManageExample example, RowBounds rowBounds);
    ...
    int updateByExampleSelective(@Param("record") EnterprisePerManage record, @Param("example") EnterprisePerManageExample example);
    ...
    int updateByExample(@Param("record") EnterprisePerManage record, @Param("example") EnterprisePerManageExample example);
