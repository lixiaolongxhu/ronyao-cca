...
public class EnterprisePerManageSqlProvider {
	...
	public String insertSelective(EnterprisePerManage record) {
		...
		if (record.getProfessiontype() != null) {
			VALUES("professionType", "#{professiontype,jdbcType=TINYINT}");
		}
		if (record.getOnemanager() != null) {
			VALUES("oneManager", "#{onemanager,jdbcType=TINYINT}");
		}
		if (record.getTwomanager() != null) {
			VALUES("twoManager", "#{twomanager,jdbcType=TINYINT}");
		}
		if (record.getOnechief() != null) {
			VALUES("oneChief", "#{onechief,jdbcType=TINYINT}");
		}
		if (record.getTwochief() != null) {
			VALUES("twoChief", "#{twochief,jdbcType=TINYINT}");
		}
		if (record.getSafetyofficer() != null) {
			VALUES("safetyOfficer", "#{safetyofficer,jdbcType=TINYINT}");
		}
		if (record.getInspector() != null) {
			VALUES("inspector", "#{inspector,jdbcType=TINYINT}");
		}
		if (record.getTechnician() != null) {
			VALUES("technician", "#{technician,jdbcType=TINYINT}");
		}
		if (record.getCostmember() != null) {
			VALUES("costMember", "#{costmember,jdbcType=TINYINT}");
		}
		if (record.getDocumenter() != null) {
			VALUES("documenter", "#{documenter,jdbcType=TINYINT}");
		}
		if (record.getIntegrator() != null) {
			VALUES("integrator", "#{integrator,jdbcType=TINYINT}");
		}
		if (record.getMaterial() != null) {
			VALUES("material", "#{material,jdbcType=TINYINT}");
		}
		if (record.getExpeditor() != null) {
			VALUES("expeditor", "#{expeditor,jdbcType=TINYINT}");
		}
		if (record.getConstructionteam() != null) {
			VALUES("constructionTeam", "#{constructionteam,jdbcType=TINYINT}");
		}
		if (record.getPlurality() != null) {
			VALUES("plurality", "#{plurality,jdbcType=TINYINT}");
		}
		if (record.getSum() != null) {
			VALUES("sum", "#{sum,jdbcType=TINYINT}");
		}
	...
	public String updateByExampleSelective(Map<String, Object> parameter) {
		...
		if (record.getProfessiontype() != null) {
			SET("professionType = #{record.professiontype,jdbcType=TINYINT}");
		}
		if (record.getOnemanager() != null) {
			SET("oneManager = #{record.onemanager,jdbcType=TINYINT}");
		}
		if (record.getTwomanager() != null) {
			SET("twoManager = #{record.twomanager,jdbcType=TINYINT}");
		}
		if (record.getOnechief() != null) {
			SET("oneChief = #{record.onechief,jdbcType=TINYINT}");
		}
		if (record.getTwochief() != null) {
			SET("twoChief = #{record.twochief,jdbcType=TINYINT}");
		}
		if (record.getSafetyofficer() != null) {
			SET("safetyOfficer = #{record.safetyofficer,jdbcType=TINYINT}");
		}
		if (record.getInspector() != null) {
			SET("inspector = #{record.inspector,jdbcType=TINYINT}");
		}
		if (record.getTechnician() != null) {
			SET("technician = #{record.technician,jdbcType=TINYINT}");
		}
		if (record.getCostmember() != null) {
			SET("costMember = #{record.costmember,jdbcType=TINYINT}");
		}
		if (record.getDocumenter() != null) {
			SET("documenter = #{record.documenter,jdbcType=TINYINT}");
		}
		if (record.getIntegrator() != null) {
			SET("integrator = #{record.integrator,jdbcType=TINYINT}");
		}
		if (record.getMaterial() != null) {
			SET("material = #{record.material,jdbcType=TINYINT}");
		}
		if (record.getExpeditor() != null) {
			SET("expeditor = #{record.expeditor,jdbcType=TINYINT}");
		}
		if (record.getConstructionteam() != null) {
			SET("constructionTeam = #{record.constructionteam,jdbcType=TINYINT}");
		}
		if (record.getPlurality() != null) {
			SET("plurality = #{record.plurality,jdbcType=TINYINT}");
		}
		if (record.getSum() != null) {
			SET("sum = #{record.sum,jdbcType=TINYINT}");
		}
		if (record.getCreatetime() != null) {
	...
	public String updateByPrimaryKeySelective(EnterprisePerManage record) {
		...
		if (record.getProfessiontype() != null) {
			SET("professionType = #{professiontype,jdbcType=TINYINT}");
		}
		if (record.getOnemanager() != null) {
			SET("oneManager = #{onemanager,jdbcType=TINYINT}");
		}
		if (record.getTwomanager() != null) {
			SET("twoManager = #{twomanager,jdbcType=TINYINT}");
		}
		if (record.getOnechief() != null) {
			SET("oneChief = #{onechief,jdbcType=TINYINT}");
		}
		if (record.getTwochief() != null) {
			SET("twoChief = #{twochief,jdbcType=TINYINT}");
		}
		if (record.getSafetyofficer() != null) {
			SET("safetyOfficer = #{safetyofficer,jdbcType=TINYINT}");
		}
		if (record.getInspector() != null) {
			SET("inspector = #{inspector,jdbcType=TINYINT}");
		}
		if (record.getTechnician() != null) {
			SET("technician = #{technician,jdbcType=TINYINT}");
		}
		if (record.getCostmember() != null) {
			SET("costMember = #{costmember,jdbcType=TINYINT}");
		}
		if (record.getDocumenter() != null) {
			SET("documenter = #{documenter,jdbcType=TINYINT}");
		}
		if (record.getIntegrator() != null) {
			SET("integrator = #{integrator,jdbcType=TINYINT}");
		}
		if (record.getMaterial() != null) {
			SET("material = #{material,jdbcType=TINYINT}");
		}
		if (record.getExpeditor() != null) {
			SET("expeditor = #{expeditor,jdbcType=TINYINT}");
		}
		if (record.getConstructionteam() != null) {
			SET("constructionTeam = #{constructionteam,jdbcType=TINYINT}");
		}
		if (record.getPlurality() != null) {
			SET("plurality = #{plurality,jdbcType=TINYINT}");
		}
		if (record.getSum() != null) {
			SET("sum = #{sum,jdbcType=TINYINT}");
		}
		if (record.getCreatetime() != null) {
