...
public class EnterprisePerManageSqlProvider {
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        EnterprisePerManage record = (EnterprisePerManage) parameter.get("record");
        EnterprisePerManageExample example = (EnterprisePerManageExample) parameter.get("example");
     ...
     * @mbggenerated Tue Dec 29 14:59:40 CST 2015
     */
    protected void applyWhere(EnterprisePerManageExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
