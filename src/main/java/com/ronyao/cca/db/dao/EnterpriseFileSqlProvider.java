...
public class EnterpriseFileSqlProvider {
    ...
    public String insertSelective(EnterpriseFile record) {
        ...
        if (record.getAptituderankid() != null) {
            VALUES("aptitudeRankId", "#{aptituderankid,jdbcType=TINYINT}");
        }
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getAptituderankid() != null) {
            SET("aptitudeRankId = #{record.aptituderankid,jdbcType=TINYINT}");
        }
    ...
    public String updateByPrimaryKeySelective(EnterpriseFile record) {
        ...
        if (record.getAptituderankid() != null) {
            SET("aptitudeRankId = #{aptituderankid,jdbcType=TINYINT}");
        }
