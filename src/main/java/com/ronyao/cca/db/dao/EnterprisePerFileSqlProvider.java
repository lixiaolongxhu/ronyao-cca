...
public class EnterprisePerFileSqlProvider {
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        EnterprisePerFileExample example = (EnterprisePerFileExample) parameter.get("example");
     ...
     * @mbggenerated Tue Dec 29 14:59:40 CST 2015
     */
    protected void applyWhere(EnterprisePerFileExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
