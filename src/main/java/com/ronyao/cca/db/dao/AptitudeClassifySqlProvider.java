...
public class AptitudeClassifySqlProvider {
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        AptitudeClassifyExample example = (AptitudeClassifyExample) parameter.get("example");
     ...
     * @mbggenerated Tue Dec 29 14:59:40 CST 2015
     */
    protected void applyWhere(AptitudeClassifyExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
