...
public class EnterprisePerStandardSqlProvider {
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        EnterprisePerStandard record = (EnterprisePerStandard) parameter.get("record");
        EnterprisePerStandardExample example = (EnterprisePerStandardExample) parameter.get("example");
     ...
     * @mbggenerated Tue Dec 29 14:59:40 CST 2015
     */
    protected void applyWhere(EnterprisePerStandardExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
