...
public interface EnterpriseAptitudeMapper {
     ...
     */
    @Delete({
        "delete from enterprise_aptitude",
    ...
    List<EnterpriseAptitude> selectByExampleWithRowbounds(EnterpriseAptitudeExample example, RowBounds rowBounds);
    ...
    int updateByExampleSelective(@Param("record") EnterpriseAptitude record, @Param("example") EnterpriseAptitudeExample example);
    ...
    int updateByExample(@Param("record") EnterpriseAptitude record, @Param("example") EnterpriseAptitudeExample example);
