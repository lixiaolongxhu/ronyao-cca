...
public interface ProjectPlainMapper {
    ...
    List<ProjectPlain> selectByExampleWithRowbounds(ProjectPlainExample example, RowBounds rowBounds);
    ...
    int updateByExampleSelective(@Param("record") ProjectPlain record, @Param("example") ProjectPlainExample example);
    ...
    int updateByExample(@Param("record") ProjectPlain record, @Param("example") ProjectPlainExample example);
