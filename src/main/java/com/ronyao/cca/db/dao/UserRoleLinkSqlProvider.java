...
public class UserRoleLinkSqlProvider {
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        UserRoleLinkExample example = (UserRoleLinkExample) parameter.get("example");
     ...
     * @mbggenerated Wed Dec 09 15:42:41 CST 2015
     */
    protected void applyWhere(UserRoleLinkExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
