...
import com.ronyao.cca.db.model.rolePermissionLinkExample.Criteria;
import com.ronyao.cca.db.model.rolePermissionLinkExample.Criterion;
...
public class rolePermissionLinkSqlProvider {
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        rolePermissionLink record = (rolePermissionLink) parameter.get("record");
        rolePermissionLinkExample example = (rolePermissionLinkExample) parameter.get("example");
     ...
     * @mbggenerated Wed Dec 09 15:42:41 CST 2015
     */
    protected void applyWhere(rolePermissionLinkExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
