...
public class ProjectBuildSqlProvider {
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        ProjectBuildExample example = (ProjectBuildExample) parameter.get("example");
     ...
     * @mbggenerated Tue Dec 29 14:59:40 CST 2015
     */
    protected void applyWhere(ProjectBuildExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
