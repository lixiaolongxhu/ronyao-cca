...
public interface AnnualOutputMapper {
    ...
    @Insert({
        ...
        "timeLimit, projectNum, ",
        "annualOutPut, remark, ",
        "createTime, updateTime)",
        "values (#{voltagerankid,jdbcType=INTEGER}, #{projecttype,jdbcType=TINYINT}, ",
        "#{timelimit,jdbcType=TINYINT}, #{projectnum,jdbcType=DECIMAL}, ",
    ...
    @Results({
        ...
        @Result(column="timeLimit", property="timelimit", jdbcType=JdbcType.TINYINT),
    ...
    List<AnnualOutput> selectByExampleWithRowbounds(AnnualOutputExample example, RowBounds rowBounds);
    ...
    @Select({
        "select",
        "id, voltageRankId, projectType, timeLimit, projectNum, annualOutPut, remark, ",
        "createTime, updateTime",
        "from annual_output",
        "where id = #{id,jdbcType=TINYINT}"
    })
    ...
    int updateByExampleSelective(@Param("record") AnnualOutput record, @Param("example") AnnualOutputExample example);
    ...
    int updateByExample(@Param("record") AnnualOutput record, @Param("example") AnnualOutputExample example);
    ...
    @Update({
        ...
        "set voltageRankId = #{voltagerankid,jdbcType=INTEGER},",
          ...
          "timeLimit = #{timelimit,jdbcType=TINYINT},",
