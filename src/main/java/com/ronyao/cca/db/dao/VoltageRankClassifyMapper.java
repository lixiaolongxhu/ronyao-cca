...
public interface VoltageRankClassifyMapper {
     ...
     */
    @Delete({
        "delete from voltage_rank_classify",
     ...
     */
    @Insert({
        "insert into voltage_rank_classify (id, name, ",
        "value, bigEquipment)",
    ...
    List<VoltageRankClassify> selectByExampleWithRowbounds(VoltageRankClassifyExample example, RowBounds rowBounds);
    ...
    int updateByExampleSelective(@Param("record") VoltageRankClassify record, @Param("example") VoltageRankClassifyExample example);
    ...
    int updateByExample(@Param("record") VoltageRankClassify record, @Param("example") VoltageRankClassifyExample example);
