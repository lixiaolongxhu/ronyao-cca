...
public interface AptitudeClassifyMapper {
     ...
     * This method corresponds to the database table aptitude_classify
     *
     ...
     */
    @Insert({
        "insert into aptitude_classify (id, name)",
    ...
    List<AptitudeClassify> selectByExampleWithRowbounds(AptitudeClassifyExample example, RowBounds rowBounds);
    ...
    int updateByExampleSelective(@Param("record") AptitudeClassify record, @Param("example") AptitudeClassifyExample example);
    ...
    int updateByExample(@Param("record") AptitudeClassify record, @Param("example") AptitudeClassifyExample example);
