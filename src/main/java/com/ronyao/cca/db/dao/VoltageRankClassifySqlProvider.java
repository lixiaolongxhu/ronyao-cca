...
public class VoltageRankClassifySqlProvider {
	...
	public String updateByExampleSelective(Map<String, Object> parameter) {
		VoltageRankClassify record = (VoltageRankClassify) parameter
				.get("record");
		VoltageRankClassifyExample example = (VoltageRankClassifyExample) parameter
				.get("example");
		BEGIN();
	 ...
	 * @mbggenerated  Thu Dec 17 09:52:13 CST 2015
	 */
	protected void applyWhere(VoltageRankClassifyExample example,
