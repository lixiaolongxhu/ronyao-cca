...
public interface BehaviorMapper {
    ...
    @Insert({
        ...
        "#{createtime,jdbcType=TINYINT}, #{updatetime,jdbcType=TINYINT})"
    })
    ...
    @Results({
        ...
        @Result(column="createTime", property="createtime", jdbcType=JdbcType.TINYINT),
        @Result(column="updateTime", property="updatetime", jdbcType=JdbcType.TINYINT)
    })
    List<Behavior> selectByExampleWithRowbounds(BehaviorExample example, RowBounds rowBounds);
    ...
    @Select({
        "select",
        "id, enterpriseId, year, generalbadNum, seriousBadNum, createTime, updateTime",
        "from behavior",
        "where id = #{id,jdbcType=INTEGER}"
    })
    @Results({
    ...
    @Update({
        ...
        "set enterpriseId = #{enterpriseid,jdbcType=INTEGER},",
          ...
          "updateTime = #{updatetime,jdbcType=TINYINT}",
        "where id = #{id,jdbcType=INTEGER}"
    })
