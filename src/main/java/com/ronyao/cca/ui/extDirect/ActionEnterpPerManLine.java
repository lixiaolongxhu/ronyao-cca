 ...
 */
@Service
public class ActionEnterpPerManLine {
	
	
	private static final  Logger  LOG=LoggerFactory.getLogger(ActionEnterpPerManLine.class);
	...
	public ExtDirectStoreReadResult<EnterprisePerManage> create(List<EnterprisePerManage> enterprisePerStaList) {
		...
		ep.setProfessiontype(ConstEnterprisePerMan.LINE_PROFESSION);
		//人员合计
